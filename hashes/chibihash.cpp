...
REGISTER_HASH(ChibiHash64_V2,
   $.desc            = "ChibiHash64 - Version 2",
   $.hash_flags      =
   ...
   $.impl_flags      =
         ...
         0,
   $.bits            = 64,
   // not sure what's supposed to be done here since ChibiHash always reads in
   // little-endian order ¯\_(ツ)_/¯
