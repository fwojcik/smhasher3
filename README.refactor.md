...
- hasshe2
-- Added a variant tweaked to add in the length to the initial state
--- This way it passes AppendZeroes tests
...
- metrohash
-- All variants were combined into one file
--- This allows for much more direct comparison between variants
...
--- exact/inexact is what SMHasher3 calls strict/not
