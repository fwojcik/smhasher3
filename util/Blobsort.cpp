...
double baseline_timing[6][9] = {
    { 40.4,  38.9, 46.7, 44.4,  9.2,  36.5,  9.7, 44.8 },
    { 82.1,  82.0, 90.2, 89.5, 15.2,  82.1, 15.3, 89.9 },
    { 22.2, 123.2, 26.5, 34.7, 13.1, 124.2, 13.1, 41.1 },
    { 23.9, 144.1, 29.8, 36.6, 15.2, 144.0, 15.2, 44.1 },
    { 26.2, 208.6, 40.4, 40.4, 16.9, 209.1, 16.9, 48.5 },
    { 30.0, 180.8, 31.0, 33.1, 17.9, 181.4, 18.0, 49.1 },
};
